package com.startandroidlessons.p0821handleradvmessage;
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    ...
                    case STATUS_DOWNLOAD_START:
                        tvStatus.setText("Start download " +
                                msg.arg1 + " files");
                    ...
                    case STATUS_DOWNLOAD_FILE:
                        tvStatus.setText("Downloading. Left " +
                                msg.arg2 + " files");
            ...
            public void run() {
                try {
                    ...
                    for (int i = 0; i <= filesCount; i++) {
                        file = downloadFile();
                        msg = h.obtainMessage(STATUS_DOWNLOAD_FILE,
                                i, filesCount - i, file);
                        h.sendMessage(msg);
                    }
