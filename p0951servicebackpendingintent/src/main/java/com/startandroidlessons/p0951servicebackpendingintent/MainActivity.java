package com.startandroidlessons.p0951servicebackpendingintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickStart(View v) {
        ...
        pi = createPendingResult(TASK1_CODE, voidIntent, 0);
        intent = new Intent(this, MyService.class).putExtra(PARAM_TIME, 7)
                .putExtra(PARAM_PINTENT, pi);
        startService(intent);

        pi = createPendingResult(TASK2_CODE, voidIntent, 0);
        intent = new Intent(this, MyService.class).putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_PINTENT, pi);
        startService(intent);

        pi = createPendingResult(TASK3_CODE, voidIntent, 0);
