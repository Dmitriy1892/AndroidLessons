package com.startandroidlessons.p0531simplecursortreeadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleCursorTreeAdapter sctAdapter = new MyAdater(this, cursor,
    ...
    class MyAdater extends SimpleCursorTreeAdapter {

        public MyAdater(Context context, Cursor cursor,
